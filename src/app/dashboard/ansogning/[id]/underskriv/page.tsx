...
export default async function UnderscrivPage({ params }: Props) {
  ...
  return (
    <div className="max-w-3xl">
      <div className="mb-6">
        <h2 className="text-xl font-bold text-gray-900">Digital underskrift</h2>
        <p className="text-sm text-gray-500 mt-1">
          Underskriv fuldmagtsdokumentet digitalt for at autorisere vores advokater til at handle på dine vegne.
        </p>
      </div>
      ...
      <div className="mb-8 bg-white rounded-xl p-4 shadow-sm border border-gray-100">
        <div className="flex items-center justify-between text-xs text-gray-500 mb-2">
          <span>Trin 2 af 3: Underskrift</span>
          <span>66%</span>
        </div>
